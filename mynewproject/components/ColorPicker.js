...
class ColorPicker extends Component{
  ...
  return(
    ...
    <View style={{  justifyContent: 'center', alignItems:'center', flex:1}}>
      <Modal animationType={'slide'} transparent={true} visible={this.props.isVisible === true}>
          <View style={{ width: '100%', height: '100%', flex: 1, justifyContent: 'flex-end', alignItems: 'center' }}>
              ...
              <View style={{ position: 'absolute', width: '100%', height: '45%', backgroundColor: 'white', flex: 1}}>
                 ...
                 <AntDesign name="close" style = {styles.menuIcon} size ={24} onPress={() => {this.props.toggleColorModal(false)}}   />
                 <View style= {styles.stat}>
                   <Text style={styles.modal_title}> {this.props.name} Text Color </Text>
                 </View>
                     ...
                     <Text style={{fontSize:30 ,color: this.props.text_color == null ? 'red':
                       fromHsv({ h: this.props.text_color.hue, s: this.props.text_color.sat, v:this.props.text_color.val })}}> Color </Text>
